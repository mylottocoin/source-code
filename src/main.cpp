...
const string strMessageMagic = "MYLOTTOCOIN Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MYLOTTOCOIN", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1518009904, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        const char* pszTimestamp = "07022018";
        CTransaction txNew;
        txNew.nTime = 1518009904;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1518009904;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 2385274 : 2385274;
        ...
        assert(block.hashMerkleRoot == uint256("0x12bcc1d02467a1519676bb829911547a3a32b4db131a437f160225712f29eaa2"));
...
unsigned char pchMessageStart[4] = { 0xcc, 0x9f, 0x47, 0xf3 };
